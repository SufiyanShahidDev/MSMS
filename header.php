                            ...
                            <div class="hs-header-top">
                                ...
                                <ul class="hs-social-icon">
                                    ...
                                    <?php if (isset($_SESSION['user_id'])): ?>
                                        <li><a class="admin-nav" href="manage_orders.php"><i class="zmdi zmdi-receipt"></i> <span class="hide-text">Manage Orders</span></a></li>
                                        <li><a class="admin-nav" href="manage_appointments.php"><i class="zmdi zmdi-calendar"></i> <span class="hide-text">Manage Appointments</span></a></li>

                                        <?php if ($user['role'] === 'admin'): ?>
                                            <li><a class="admin-nav" href="my-account.php"><i class="zmdi zmdi-account"></i> <span class="hide-text">My Account</span></a></li>
                                            <li><a class="admin-nav" href="admin"><i class="zmdi zmdi-settings"></i> <span class="hide-text">Admin</span></a></li>

                                        <?php elseif ($user['role'] === 'staff'): ?>
                                            <li><a class="admin-nav" href="my-account.php"><i class="zmdi zmdi-account"></i> <span class="hide-text">My Account</span></a></li>
                                            <li><a class="admin-nav" href="admin"><i class="zmdi zmdi-settings"></i> <span class="hide-text">Staff</span></a></li>
